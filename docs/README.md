...
Trust these over anything in `reports/`.
...
| [`LEADERBOARD-OPERATIONS.md`](./LEADERBOARD-OPERATIONS.md) | Board ops |
| [`architecture.html`](./architecture.html) | How the game plays (not a code map) |
| [`reports/`](./reports/) | Dated snapshots. They drift. |

Plans that are still product work live in [`plans/`](../plans/), not here.
