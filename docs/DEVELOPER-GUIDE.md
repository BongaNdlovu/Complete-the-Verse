...
test.js             root test runner (runs all 55 test suites)
...
test/*.test.js      55 registered test suites (see §10)
...
`node test.js` runs 55 suites in a fixed order: content gate → pure
