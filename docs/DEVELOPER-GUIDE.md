...
test.js             root test runner (runs all 58 test suites)
...
test/*.test.js      58 registered test suites (see §10)
...
`node test.js` runs 58 suites in a fixed order: content gate → pure
