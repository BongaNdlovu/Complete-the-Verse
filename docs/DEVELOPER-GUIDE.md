...
test.js             root test runner (runs all 59 test suites)
...
test/*.test.js      59 registered test suites (see §10)
...
`node test.js` runs 59 suites in a fixed order: content gate → pure
